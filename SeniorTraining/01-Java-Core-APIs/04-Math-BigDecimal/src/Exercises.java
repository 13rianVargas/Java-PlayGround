...
public class Exercises {
    ...
    mplo: ["0.1", "0.2"]               → "0.30"
    //
    // 💡 Pista: convierte cada monto a BigDecimal con new BigDecimal(String), sumalos, aplica setScale(2, HALF_UP)
    // ─────────────────────────────────────────────────────────────────────
    ...
    atic int comparePrices(String price1, String price2) {
        // TODO
        return 0;
    }
    ...
    // ─────────────────────────────────────────────────────────────────────
    // RCICIO 5 — Temperatura más cercana a cero
    //
